...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* Fixed Header */}
      <header className="fixed top-0 left-0 w-full bg-transparent px-4 sm:px-6 py-4 z-50">
      ...
      {/* Hero Content */}
      <main className="relative z-20 flex flex-col items-center justify-center flex-1 px-4 sm:px-6 pt-32 sm:pt-40 lg:pt-48 text-center lg:text-left">

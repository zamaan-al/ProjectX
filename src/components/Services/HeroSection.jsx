      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-40  max-w-6xl w-full flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-12">
          ...
          <div className="flex-1 text-white text-center md:text-left">
            <h2 className="w-full text-2xl text-white py-3 rounded-lg mb-6 md:mb-5">
              ProjectX <span className="ml-3">|</span>
              <span className="ml-3">Edu</span>
            </h2>

            <p className="mt-6 md:mt-10 max-w-[350px] mx-auto md:mx-0 text-base leading-relaxed text-gray-200 text-justify">
              ...
              students, along with the assistance of dedicated trainers.
        ...
        {/* Divider Line */}
        <div className="mt-16 md:mt-20 flex justify-center lg:justify-start lg:ml-[20px]">

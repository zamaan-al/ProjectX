            ...
            <div className="w-full max-w-[350px]">
              ...
              <div className="w-full bg-[#082634] p-6 sm:p-8 rounded-2xl shadow-md">
                <p className="text-gray-300 leading-relaxed text-center lg:text-left text-sm sm:text-base">
                  ...
                  to the students, along with the assistance of dedicated
                  trainers. Starting with electronics at a basic level, we aim
                  to build Indian Projects and produce skilled resources for the
                  technology sector through our students.
                </p>
              </div>
            </div>
          </div>
